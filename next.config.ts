  ...
  async headers() {
    const securityHeaders = [
      ...
      },
      {
        ...
        value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://api.groq.com https://*.supabase.com wss://*.vercel.app wss://*.supabase.com ws://localhost:* http://localhost:* https://*.cloudinary.com; frame-src 'self' https://vercel.live;"
      },
    ];
