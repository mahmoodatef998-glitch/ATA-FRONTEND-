-- Database Indexes for Performance Optimization (Snake Case Version)
-- Run this if camelCase version doesn't work
-- Prisma may convert camelCase to snake_case automatically
